...
class CustomDoctorBottomNavBar extends StatelessWidget {
  const CustomDoctorBottomNavBar({
    super.key,
  });
      ...
      builder: (controller) {
        return Container(
          ...
          decoration: BoxDecoration(
            boxShadow: [
              BoxShadow(blurRadius: 5, color: mainBlack.withOpacity(.1))
            ],
            color: Colors.white,
          ),
          child: SafeArea(
            child: Padding(
              ...
              child: ListView.builder(
                ...
                itemCount: doctornavbarList.length,
