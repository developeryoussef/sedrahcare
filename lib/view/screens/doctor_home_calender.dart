...
class DoctorHomeCalendarScreen extends StatefulWidget {
  @override
  State<DoctorHomeCalendarScreen> createState() =>
      _DoctorHomeCalendarScreenState();
}

class _DoctorHomeCalendarScreenState extends State<DoctorHomeCalendarScreen> {
              ...
              child: Center(
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      Center(
                          child: Lottie.asset('assets/animation_lm324d9c.json',
                              repeat: true,
                              animate: true,
